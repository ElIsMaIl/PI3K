...
```{r}
split_filtered_sct_cond_seurat <- readRDS("E://CCCC/PI3K/data/SeuratObjects/sct_normalized/Maus/split_filtered_sct_cond_seurat.rds")
```
...
```{r}
saveRDS(integrated_filtered_sct_cond_seurat, "E://CCCC/PI3K/data/SeuratObjects/integrated/Mouse/integrated_filtered_sct_cond_seurat.rds")
```