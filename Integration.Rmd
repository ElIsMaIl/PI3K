...
```{r normalizatíon and variable feature selection}
...
```{r Visualization}
p1 <- DimPlot(integrated_seurat, reduction = "umap", group.by = "Sample_Tag")
p2 <- DimPlot(integrated_seurat, reduction = "umap", label = TRUE, repel = TRUE)
p3 <- DimPlot(integrated_seurat, reduction = "umap", split.by = "Sample_Tag")
#p1
#p2
#p3
```
