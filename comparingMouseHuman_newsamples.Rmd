...
Independent alignment on mouse or human suggests, using the comprehensive annotation file:
  ...
  - sample 7273 has   % human vs % mouse
...
```{r umiStatistics_7272, fig.cap= "The figure shows the molecular index statistics for the 7271 sample"}
...
cell_List_human <- Cells(list_seurat_7270h[["7270"]]@assays[["RNA"]]@data)
cell_List_mouse <- Cells(list_seurat_7270m[["7270"]]@assays[["RNA"]]@data)

#---- extract gene list from human and mouse from their Seurat object
gene_List_human <- row.names(list_seurat_7270h[["7270"]]@assays[["RNA"]]@data)
gene_List_mouse <- row.names(list_seurat_7270m[["7270"]]@assays[["RNA"]]@data)


#---- plot Venn diagrams
venn_cells7270 <- venn(list(Human = cell_List_human,
                            Mouse = cell_List_mouse))

venn_genes7270 <- venn(list(Human = gene_List_human,
                            Mouse = gene_List_mouse))
...
#---- extract cell list from human and mouse from their Seurat object
cell_List_h <- Cells(list_seurat_7271h[["7271"]]@assays[["RNA"]]@data)
cell_List_m <- Cells(list_seurat_7271m[["7271"]]@assays[["RNA"]]@data)

#---- extract gene list from human and mouse from their Seurat object
gene_List_h <- row.names(list_seurat_7271h[["7271"]]@assays[["RNA"]]@data)
gene_List_m <- row.names(list_seurat_7271m[["7271"]]@assays[["RNA"]]@data)


#---- plot Venn diagrams
venn_cells7271 <- venn(list(Human = cell_List_h,
                            Mouse = cell_List_m))

venn_genes7271 <- venn(list(Human = gene_List_h,
                            Mouse = gene_List_m))
...
#---- extract gene list from human and mouse from their Seurat object
gene_List_7272h <- row.names(list_seurat_7272h[["7272"]]@assays[["RNA"]]@data)
gene_List_7272m <- row.names(list_seurat_7272m[["7272"]]@assays[["RNA"]]@data)
