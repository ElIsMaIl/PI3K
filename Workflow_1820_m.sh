...
#mkdir -p ~/work/PIP3K/R_1820/results_fastqc/
...
#mkdir -p ~/work/PIP3K/R_1820/Hisat2/
cd ~/work/PIP3K/R_1820/Hisat2/
...
for ((i=1; i<=8; i++));
do
R1=$(ls ~/work/PIP3K/R_1820/trimmed_reads/1820_S1_L00${i}_R1_001.fastq_1_paired.fastq)
R2=$(ls ~/work/PIP3K/R_1820/trimmed_reads/1820_S1_L00${i}_R2_001.fastq_2_paired.fastq)
 
hisat2 -p 20 -x ~/work/PIP3K/R_1820/Hisat2/hisat2_ref -q -1 ${R1} -2 ${R2} -S align${i}.sam
samtools view -S -b ~/work/PIP3K/R_1820/Hisat2/align${i}.sam > align${i}.bam
samtools sort ~/work/PIP3K/R_1820/Hisat2/align${i}.bam -o align${i}.sorted.bam
rm *.sam
done
...
for ((i=1; i<=8; i++));
do
stringtie ~/work/PIP3K/R_1820/Hisat2/align${i}.sorted.bam -l stringtie_${i} -p 20 -G ~/work/PIP3K/ref_files/gencodev29-20181205.gtf -o ~/work/PIP3K/R_1820/stringtie_assembly/stringtie_${i}.gtf
stringtie --merge -p 20 -G ~/work/PIP3K/ref_files/gencodev29-20181205.gtf -o ~/work/PIP3K/R_1820/stringtie_assembly/stringtie_merged.gtf ~/work/PIP3K/R_1820/stringtie_assembly/stringtie_${i}.gtf
done 

cd ~/work/PIP3K/R_1820/stringtie_assembly
gffcompare -r ~/work/PIP3K/ref_files/gencodev29-20181205.gtf -G -o merged stringtie_merged.gtf

#Read Coverage Tables
echo "Estimate Transcript abundances..."
for ((i=1; i<=8; i++));
do
stringtie -e -B -p 20 -G ~/work/PIP3K/R_1820/stringtie_assembly/stringtie_merged.gtf -o ballgown/reads${i}/aligned${i}.gtf ~/work/PIP3K/R_1820/Hisat2/align${i}.sorted.bam
done 
