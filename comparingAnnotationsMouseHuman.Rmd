...
```{r fig.cap= "GC Content plot from the 1820 & 1822 sample.", layout="l-page"}
...
cellLabel1820 <- readImage("plots/1820_Cell_Label_Second_Derivative_Curve_Human.png")
display(cellLabel1820)
```

```{r fig.cap= "Result of the second derivative analysis of the 1822 sample aligned to the human genome."}
cellLabel1822 <- readImage("plots/1822_Cell_Label_Second_Derivative_Curve.png")
display(cellLabel1822)
```

```{r fig.cap= "Result of the second derivative analysis of the 1820 sample aligned to the mouse genome."}
cellLabel_mouse <- readImage("plots/1820_Cell_Label_Second_Derivative_Curve_mouse.png")
display(cellLabel_mouse)
```

```{r fig.cap= "Result of the second derivative analysis of the 1822 sample aligned to the mouse genome."}
cellLabel1822_mouse<- readImage("plots/1822_Cell_Label_Second_Derivative_Curve_mouse.png")
display(cellLabel1822_mouse)
```
