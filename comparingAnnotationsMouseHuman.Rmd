...
genes_1820m<- convertMouseGeneList(list_seurat_1820m[["1820"]]@assays[["RNA"]]@data@Dimnames[[1]])
...
#---- map mouse gene names to human gene names
genes_1822m <- convertMouseGeneList(list_seurat_1822m[["1822"]]@assays[["RNA"]]@data@Dimnames[[1]])


#---- extract cell list from human and mouse from their Seurat object
cell_List_human <- Cells(list_seurat_1822h[["1822"]]@assays[["RNA"]]@data)
cell_List_mouse <- Cells(list_seurat_1822m[["1822"]]@assays[["RNA"]]@data)

#---- extract gene list from human and mouse from their Seurat object
gene_List_human <- row.names(list_seurat_1822h[["1822"]]@assays[["RNA"]]@data)
