...
- [ ] calculation of mt-expressed RNA in mouse -> update when finished
- [ ] annotation of FeatureScatter plot (What does 0.14 / 0.18 mean)?
- [ ] overlap between cells, which have mouse and human genes vs. mouse genes -> venn-diagram / histogram
- [ ] name-mapping between mouse / human
- [ ] how many genes are the same in mouse human?
...
```{r}
#| fig.keep = "all",
#| fig.cap = "These scatter plots show the relation between the human and mouse data points for sample 1820 in relation to their percentage of mitochondrial genes."
...
```{r}
#| fig.keep = "all",
#| fig.cap = "The scatter plots show the relation between the human and mouse data points for sample 1822 in relation to their percentage of mitochondrial genes."
