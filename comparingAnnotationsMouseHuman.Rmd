...
The following four plots show the samples which were aligned to the human genome.
![](plots/1820_Cell_Label_Filter_Human.png)
![](plots/1820_Cell_Label_Second_Derivative_Curve_Human.png)
![](plots/1822_Cell_Label_Filter.png)
![](plots/1822_Cell_Label_Second_Derivative_Curve.png)
The next four plots show the samples which were aligned to the mouse genome.
![](plots/1820_Cell_Label_Filter_Mouse.png)
