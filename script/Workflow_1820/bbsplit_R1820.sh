...
R2=$(ls ~/scratch/tmp/R1820/trimmed_reads/1820_S1_L002_R2_001.fastq_trimmed.fastq)
bbsplit.sh minratio=0.56 minhits=1 maxindel=16000 in=${R2} ref=/fast/users/elismaim_c/work/PIP3K/ref_files/Mouse/GRCm38.primary_assembly.genome.fa basename=${R2}_m_out_%.sam out_1820=${R2}_m_clean.fq ambiguous2=all refstats=statisticsM_%.txt

R2=$(ls ~/scratch/tmp/R1820/trimmed_reads/1820_S1_L003_R2_001.fastq_trimmed.fastq)
bbsplit.sh minratio=0.56 minhits=1 maxindel=16000 in=${R2} ref=/fast/users/elismaim_c/work/PIP3K/ref_files/Mouse/GRCm38.primary_assembly.genome.fa basename=${R2}_m_out_%.sam out_1820=${R2}_m_clean.fq ambiguous2=all refstats=statisticsM_%.txt

R2=$(ls ~/scratch/tmp/R1820/trimmed_reads/1820_S1_L004_R2_001.fastq_trimmed.fastq)
bbsplit.sh minratio=0.56 minhits=1 maxindel=16000 in=${R2} ref=/fast/users/elismaim_c/work/PIP3K/ref_files/Mouse/GRCm38.primary_assembly.genome.fa basename=${R2}_m_out_%.sam out_1820=${R2}_m_clean.fq ambiguous2=all refstats=statisticsM_%.txt

R2=$(ls ~/scratch/tmp/R1820/trimmed_reads/1820_S1_L005_R2_001.fastq_trimmed.fastq)
bbsplit.sh minratio=0.56 minhits=1 maxindel=16000 in=${R2} ref=/fast/users/elismaim_c/work/PIP3K/ref_files/Mouse/GRCm38.primary_assembly.genome.fa basename=${R2}_m_out_%.sam out_1820=${R2}_m_clean.fq ambiguous2=all refstats=statisticsM_%.txt

R2=$(ls ~/scratch/tmp/R1820/trimmed_reads/1820_S1_L006_R2_001.fastq_trimmed.fastq)
bbsplit.sh minratio=0.56 minhits=1 maxindel=16000 in=${R2} ref=/fast/users/elismaim_c/work/PIP3K/ref_files/Mouse/GRCm38.primary_assembly.genome.fa basename=${R2}_m_out_%.sam out_1820=${R2}_m_clean.fq ambiguous2=all refstats=statisticsM_%.txt

R2=$(ls ~/scratch/tmp/R1820/trimmed_reads/1820_S1_L007_R2_001.fastq_trimmed.fastq)
bbsplit.sh minratio=0.56 minhits=1 maxindel=16000 in=${R2} ref=/fast/users/elismaim_c/work/PIP3K/ref_files/Mouse/GRCm38.primary_assembly.genome.fa basename=${R2}_m_out_%.sam out_1820=${R2}_m_clean.fq ambiguous2=all refstats=statisticsM_%.txt

R2=$(ls ~/scratch/tmp/R1820/trimmed_reads/1820_S1_L008_R2_001.fastq_trimmed.fastq)
bbsplit.sh minratio=0.56 minhits=1 maxindel=16000 in=${R2} ref=/fast/users/elismaim_c/work/PIP3K/ref_files/Mouse/GRCm38.primary_assembly.genome.fa basename=${R2}_m_out_%.sam out_1820=${R2}_m_clean.fq ambiguous2=all refstats=statisticsM_%.txt
