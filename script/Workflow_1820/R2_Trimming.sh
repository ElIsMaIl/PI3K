...
# mkdir -p ~/scratch/tmp/1820/STAR/human/index_trimmed/
# cd ~/scratch/tmp/1820/STAR/human/index_trimmed/
#
# STAR --runThreadN 8 \
#      --runMode genomeGenerate \
#      --genomeDir /fast/users/elismaim_c/scratch/tmp/1820/STAR/human/index_trimmed/ \
...
# echo "starting the next step..."
# echo "Alignment..."
# mkdir -p ~/scratch/tmp/1820/STAR/human/alignment_trimmed/
# cd ~/scratch/tmp/1820/STAR/human/alignment_trimmed/
#
# for ((i=1; i<=8; i++));
# do
...
#        --readFilesIn ${R2} \
#        --outFileNamePrefix ~/scratch/tmp/1820/STAR/human/alignment_trimmed/1820hs_${i}
#
# done

#samtools index ~/scratch/tmp/1820/STAR/human/alignment_trimmed/1820hs_${i}Aligned.sortedByCoord.out.bam
#samtools view -b -F 4 ~/scratch/tmp/1820/STAR/human/alignment_trimmed/1820hs_${i}Aligned.sortedByCoord.out.bam > 1820hs_${i}.mapped.sorted.bam
#samtools merge 1820h_merged.bam ~/scratch/tmp/1820/STAR/human/alignment_trimmed/*.mapped.sorted.bam



# echo "STAR genome index"
# mkdir -p ~/scratch/tmp/1820/STAR/mouse/index_trimmed/
# cd ~/scratch/tmp/1820/STAR/mouse/index_trimmed/
#
# STAR --runThreadN 8 \
#      --runMode genomeGenerate \
#      --genomeDir /fast/users/elismaim_c/scratch/tmp/1820/STAR/mouse/index_trimmed/ \
...
# echo "starting the next step..."
# echo "Alignment..."
# mkdir -p ~/scratch/tmp/1820/STAR/mouse/alignment_index/
# cd ~/scratch/tmp/1820/STAR/mouse/alignment_index/
#
# for ((i=1; i<=8; i++));
# do
# R2=$(ls ~/scratch/tmp/1820/trimmed_reads/1820_S1_L00${i}_R2_001.fastq.gz_trimmed.fastq)
...
#       --outSAMtype BAM SortedByCoordinate \
#       --readFilesIn ${R2} \
#       --outFileNamePrefix ~/scratch/tmp/1820/STAR/mouse/alignment_trimmed/1820ms_${i}
#
# done

#samtools index ~/scratch/tmp/1820/STAR/mouse/alignment_trimmed/1820ms_${i}Aligned.sortedByCoord.out.bam
#samtools view -b -F 4 ~/scratch/tmp/1820/STAR/mouse/alignment_trimmed/1820ms_${i}Aligned.sortedByCoord.out.bam > 1820ms_${i}.mapped.sorted.bam
#samtools merge 1820m_merged.bam ~/scratch/tmp/1820/STAR/mouse/alignment_trimmed/*.mapped.sorted.bam
