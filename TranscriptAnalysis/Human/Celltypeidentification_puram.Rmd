...
```{r}
seurat_integrated_filtered$predicted.match <- seurat_integrated_filtered$predicted.id == puram_sct$cell.type
table(seurat_integrated_filtered$predicted.match)
