...
FeaturePlot(filtered_phase_seurat,
            features = "percent.mt")+
   ggtitle("Mitochondrial gene expression distribution in UMAP cluster")+
   scale_fill_lancet()
```
...
```{r}
saveRDS(split_filtered_cond_seurat, file="E://CCCC/PI3K/data/SeuratObjects/splitted/Mouse/split_filtered_cond_seurat.rds")
```
...
```{r}
#split_filtered_cond_seurat <- readRDS("E:/CCCC/PI3K/data/SeuratObjects/splitted/Mouse/split_filtered_cond_seurat.rds")
...
```{r}
saveRDS(split_filtered_sct_cond_seurat, file="E://CCCC/PI3K/data/SeuratObjects/sct_normalized/Maus/split_filtered_sct_cond_seurat.rds")
```